...
self.addEventListener('notificationclick',(e)=>{e.notification.close(),e.waitUntil(self.clients.matchAll({type:'window'}).then(t=>{t.length>0?t[0].focus():self.clients.openWindow('/Love-Letter/')}))});
